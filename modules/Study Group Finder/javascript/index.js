...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderGroups(groupsArray) {
    ...
    try {
      ...
      // Set up the correct path for detail view that points to Replit
      const detailPath = `${REPLIT_URL}/frontend/detail.html`;
